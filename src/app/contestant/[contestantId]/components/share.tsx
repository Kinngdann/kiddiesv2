...
export function ShareLink({ contestantName }: ShareLinkProps) {
  ...
  const whatsappText = contestantName
    ? `Help ${contestantName} win the Kiddies Crown Contest! Every vote is only ₦50. Vote here: ${url}`
    : `Vote now on Kiddies Crown! Every vote is only ₦50. Vote here: ${url}`;
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Share this contestant</DialogTitle>
          <DialogDescription>
        ...
        <div className="grid gap-4">
          ...
          <div className="flex gap-2">
            <div className="grid flex-1 gap-2">
              ...
              <Input id="link" value={url} readOnly className="text-xs" />
            </div>
            <Button
              type="button"
              size="icon"

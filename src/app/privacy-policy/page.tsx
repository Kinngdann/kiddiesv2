      ...
      <div className="max-w-[70ch] mx-auto space-y-6 pt-4 [&_h2]:font-bold [&_h2]:text-black [&_h2]:text-2xl [&_h2]:mt-10 [&_h2]:mb-3 [&_h3]:font-bold [&_h3]:text-black [&_h3]:text-lg [&_h3]:mt-6 [&_h3]:mb-2 [&_h4]:font-bold [&_h4]:text-black [&_h4]:mt-4 [&_p]:text-gray-600 [&_p]:font-semibold [&_p]:text-sm [&_p]:leading-relaxed [&_ul]:space-y-2 [&_li]:text-gray-600 [&_li]:font-semibold [&_li]:text-sm [&_a]:underline [&_a]:underline-offset-2 [&_a]:text-[#A855F7] [&_a:hover]:opacity-70 [&_strong]:text-black">
        ...
        <ul className="list-none space-y-3">
          {[
            ...
            { term: "Company", def: "referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement, refers to Kiddies Crown, Irama Complex, Plot 4, Sa'adu, Zungur Avenue, off Wole Soyinka Avenue, 4th Avenue, Gwarinpa, Abuja." },
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            <strong>Web Beacons.</strong> Certain sections of our Service may contain
            small electronic files known as web beacons that permit the Company to count
            users who have visited those pages.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside">
          ...
          <li><strong>To contact You</strong> regarding updates and services</li>
        ...
        <p>
          ...
          the age of 13. If You are a parent and become aware that Your child has
        ...
        <div className="bg-[#FACC14] border-2 border-black rounded-2xl px-6 py-5 shadow-[4px_4px_0px_#111]">
          ...
          <p className="font-bold text-black mt-1">
            📧{" "}
            <a href="mailto:hello@kidscrown.net" className="text-black underline">
              hello@kidscrown.net
            </a>
          </p>
        </div>
